                    ...
                    if (option.group) {
                        ...
                        if (!(this.is_multiple && option.selected)) {
                            ...
                            if (regex.test(option.text)) {
                                ...
                                if (option.text.indexOf(" ") >= 0 || option.text.indexOf("[") === 0) {
        ...
        SelectParser.prototype.add_option = function(option, group_position, group_disabled) {
            if (option.nodeName === "OPTION") {
                if (option.text !== "") {
                    ...
                    this.parsed.push({array_index:this.parsed.length,options_index:this.options_index,value:option.value,text:option.text,selected:option.selected,disabled:group_disabled === true ? group_disabled : option.disabled,group_array_index:group_position});
                } else {
