 ...
 * @author fcamblor
 */
public class CreateImageContentRoute extends AbstractRoute {
    private ContentResource contentResource;

    public CreateImageContentRoute(ContentResource _contentResource){
        super(HttpMethodMatcher.PUT, new PatternUriPathMatcher("/content/image"));
    ...
    protected RequestHandler onMatch(HttpRequest request, Parameters parameters) {
        return new AbstractRequestHandler() {
            ...
            public void onRequest(HttpRequest request) {
                ...
                contentDetail.header().type(ContentType.IMAGE);
