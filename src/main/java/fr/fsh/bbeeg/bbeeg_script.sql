...
INSERT INTO CONTENT (ID, TITLE, CREATION_DATE, LAST_MODIFICATION_DATE, STATUS, DESCRIPTION, CONTENT_TYPE, AUTHOR_REF, FILE_URI, VERSION) VALUES (CONTENT_SEQ.nextval, 'Mon premier contenu', CURRENT_DATE, CURRENT_DATE, 0, 'Ceci est mon premier contenu :)', 0, USER_SEQ.currval, '', 0);
...
INSERT INTO CONTENT (ID, TITLE, CREATION_DATE, LAST_MODIFICATION_DATE, STATUS, DESCRIPTION, CONTENT_TYPE, AUTHOR_REF, FILE_URI, VERSION) VALUES (CONTENT_SEQ.nextval, 'Understand EEG', CURRENT_DATE, CURRENT_DATE, 0, 'A guide to understand EEGs', 0, USER_SEQ.currval, '', 0);