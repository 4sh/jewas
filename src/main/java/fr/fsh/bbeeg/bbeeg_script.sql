...
CREATE TABLE REJECTED_CONTENT_COMMENT (
                ID INT(10) NOT NULL,
                CONTENT_REF INT(10) NOT NULL,
...
ALTER TABLE REJECTED_CONTENT_COMMENT ADD CONSTRAINT rcc_content_fk
FOREIGN KEY (CONTENT_REF)
REFERENCES CONTENT (ID)
ON DELETE NO ACTION
ON UPDATE NO ACTION;
...
INSERT INTO CONTENT (ID, TITLE, CREATION_DATE, LAST_MODIFICATION_DATE, STATUS, DESCRIPTION, CONTENT_TYPE, AUTHOR_REF, FILE_URI, VERSION) VALUES (CONTENT_SEQ.nextval, 'Mon premier contenu', CURRENT_DATE, CURRENT_DATE, 2, 'Ceci est mon premier contenu :)', 0, USER_SEQ.currval, '', 0);
INSERT INTO CONTENT (ID, TITLE, CREATION_DATE, LAST_MODIFICATION_DATE, STATUS, DESCRIPTION, CONTENT_TYPE, AUTHOR_REF, FILE_URI, VERSION) VALUES (CONTENT_SEQ.nextval, 'Mon deuxième contenu', CURRENT_DATE, CURRENT_DATE, 0, 'Ceci est mon deuxième contenu :)', 0, USER_SEQ.currval, '', 0);
INSERT INTO CONTENT (ID, TITLE, CREATION_DATE, LAST_MODIFICATION_DATE, STATUS, DESCRIPTION, CONTENT_TYPE, AUTHOR_REF, FILE_URI, VERSION) VALUES (CONTENT_SEQ.nextval, 'Understand EEG', CURRENT_DATE, CURRENT_DATE, 1, 'A guide to understand EEGs', 0, USER_SEQ.currval, '', 0);