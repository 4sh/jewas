...
INSERT INTO CONTENT (ID, TITLE, CREATION_DATE, LAST_MODIFICATION_DATE, PUBLISHED, DESCRIPTION, CONTENT_TYPE, AUTHOR_REF, FILE_URI) VALUES (CONTENT_SEQ.nextval, 'Mon premier contenu', CURRENT_DATE, CURRENT_DATE, 0, 'Ceci est mon premier contenu :)', 0, USER_SEQ.currval, 'AFaire');
INSERT INTO CONTENT (ID, TITLE, CREATION_DATE, LAST_MODIFICATION_DATE, PUBLISHED, DESCRIPTION, CONTENT_TYPE, AUTHOR_REF, FILE_URI) VALUES (CONTENT_SEQ.nextval, 'Mon deuxième contenu', CURRENT_DATE, CURRENT_DATE, 0, 'Ceci est mon deuxième contenu :)', 0, USER_SEQ.currval, 'AFaire');
INSERT INTO CONTENT (ID, TITLE, CREATION_DATE, LAST_MODIFICATION_DATE, PUBLISHED, DESCRIPTION, CONTENT_TYPE, AUTHOR_REF, FILE_URI) VALUES (CONTENT_SEQ.nextval, 'Understand EEG', CURRENT_DATE, CURRENT_DATE, 0, 'A guide to understand EEGs', 0, USER_SEQ.currval, 'AFaire');